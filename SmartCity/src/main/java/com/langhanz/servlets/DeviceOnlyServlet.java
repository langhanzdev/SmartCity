 ...
 * @author langhanz
 */
@WebServlet(name = "DeviceOnlyServlet", urlPatterns = {"/DeviceOnlyServlet"})
public class DeviceOnlyServlet extends HttpServlet {
    
    @EJB
    private com.langhanz.smartcity.DeviceFacade deviceFacade;
    
    @Inject com.langhanz.smartcity.DeviceController dc;
